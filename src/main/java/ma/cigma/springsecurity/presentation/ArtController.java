...
public class ArtController {
	...
	//	m.addAttribute("artVo", new ArtVo());
	...
	public ModelAndView showform() {
		...
		m.addObject("artVo", new ArtVo());
		m.setViewName("/admin/emp/edit");// resources/templates/admin/emp/edit.html
		return m;
	}

	@PostMapping(value = "/save")
	public String save(@ModelAttribute("artVo") ArtVo art) {
		service.save(art);
	...
	public String viewemp(Model m) {
		List<ArtVo> list = service.getArticles();
...
//	}
	...
	public String edit(@PathVariable Long id, Model m) {
		ArtVo art = service.getArtById(id);
		m.addAttribute("artVo", art);
		return "/admin/emp/edit";
	}

	@RequestMapping(value = "/editsave", method = RequestMethod.POST)
	public String editsave(@ModelAttribute("artVo") ArtVo art) {
		service.save(art);
	...
	public String getByReference(@PathVariable String reference, Model m) {
		List<ArtVo> list = service.findByReference(reference);
		m.addAttribute("list", list);
		return "/admin/emp/list";
	}
	...
	public String getByDescription(@PathVariable String description, Model m) {
		List<ArtVo> list = service.findByDescription(description);
		m.addAttribute("list", list);
		return "/admin/emp/list";
	}
...
*/
	...
	public String pagination(@PathVariable int pageid, @PathVariable int size, Model m) {
		List<ArtVo> list = service.findAll(pageid, size);
		m.addAttribute("list", list);
		return "/admin/emp/view";
	}
	...
	public String sortBy(@PathVariable String fieldName, Model m) {
		List<ArtVo> list = service.sortBy(fieldName);
		m.addAttribute("list", list);
		return "/admin/emp/view";
	}
}
